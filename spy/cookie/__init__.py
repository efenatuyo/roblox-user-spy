...
def check(cookie):
    assert requests.get("https://users.roblox.com/v1/users/authenticated", cookies={".ROBLOSECURITY": cookie}).status_code != 401, "Invalid Cookie. PLease provide a valid cookie"